...
from ..constants import (DEFAULT_TIMEOUT_SECONDS, DEFAULT_USER_AGENT,
                         ...
                         DEFAULT_NUM_POOLS_SSH, DEFAULT_NUM_POOLS)
...
class APIClient(requests.Session, BuildApiMixin, ConfigApiMixin,
                ContainerApiMixin, DaemonApiMixin, ExecApiMixin, ImageApiMixin,
                NetworkApiMixin, PluginApiMixin, SecretApiMixin,
  ...
  __attrs__ = requests.Session.__attrs__ + [
      '_auth_configs', '_general_configs', '_version', 'base_url', 'timeout'
  ]
