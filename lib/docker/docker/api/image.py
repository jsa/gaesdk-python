...
class ImageApiMixin(object):
  ...
  def images(self, name=None, quiet=False, all=False, filters=None):
    ...
    res = self._result(
        self._get(self._url('/images/json'), params=params), True)
    if quiet:
  ...
  def import_image_from_data(self,
                             data,
                             repository=None,
                             tag=None,
                             changes=None):
  ...
  def import_image_from_stream(self,
                               stream,
                               repository=None,
                               tag=None,
                               changes=None):
  ...
  def import_image_from_image(self,
                              image,
                              repository=None,
                              tag=None,
                              changes=None):
  ...
  def search(self, term):
    """
        ...
        """
    return self._result(
        self._get(self._url('/images/search'), params={'term': term}), True)
